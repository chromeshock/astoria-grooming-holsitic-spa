...
const services = [
   ...
   //2nd row
    ...
    //7th row      
        ...
        { name: 'Dogs Basic extra large dog standard poodle and poddle mix spa', details: 'Click for more details', price: '$120', duration:     '4 hours', descriptions: descriptions.catLionCut  }, 
        { name: 'Dogs Basic extra small spa double coat', details: 'Click for more details', price: '$70', duration: '2 hours', descriptions:    descriptions.catLionCut  }, 
        { name: 'Cocker Spaniel, Cavalier Charles Kings, Cookapoo Or Similares Mixes', details: 'Click for more details', price: '$90',  duration: '2 hours', descriptions: descriptions.fullSpaDogs  }, 
        ...
        { name: 'Daycare Day/ dogs stay 9am to 7pm', details: 'Click for more details', price: '$30', duration: '1 hour', descriptions:  descriptions.catLionCut },
