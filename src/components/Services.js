...
const services = [
    { name: 'Clean Ears', details: 'Cick for more details', price: '$15', duration: '15 min', description: ''  },
    ...
    { name: 'Cut nails', price: '$30', duration: '30 min', description: descriptions.catLionCut  },
    ...
    { name: 'Face Trim', price: '$20', duration: '30 min', description: descriptions.catLionCut  },
    ...
    { name: 'Cats, Long Hair, Bath, Trim Nails, Clean Ears, Sanitary area', details: 'Cick for more details', price: '$100', duration: '2 hours', descriptions: descriptions.catsLongHair  },   
    { name: 'Cat classic for Kittens', price: '$15', duration: '30 min', description: descriptions.catLionCut  },   
    { name: 'Extra Dematting', price: '$15', duration: '10 min', description: descriptions.xtraDmat },   
    ...
    { name: 'Full spa extra large dogs standard podle and podle mix ( bath , cut the hair, clean the ears, trim the nais, blue berry facial)', price: '$120', duration: '4 hours', description: descriptions.fullSpaDogs  },
    { name: 'Full spa Double coat Large, Husky, German sharperd, Akita,( Bath , Desheading; clean the ears, trim the nails , trim paws , trim sanitary area , blue berry facial)', details: 'Cick for more details', price: '$100', duration: '2 hours', description: descriptions.fullSpaDogs },
