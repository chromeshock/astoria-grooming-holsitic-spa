...
const services = [
   ...
   //2nd row
    ...
    { name: 'Full groom spa large dogs', details: 'Cick for more details', price: '$100', duration: '3 hours', descriptions: descriptions.fullSpaDogs  },
    ...
    { name: 'Dogs Basic Extra small Double coat spa', details: 'Cick for more details', price: '$65', duration: '1 hours', descriptions: descriptions.fullSpaDogs }, 
    { name: 'Dogs Basic extra spa double coat', details: 'Cick for more details', price: '$95', duration: '2 hours', descriptions: descriptions.fullSpaDogs  }, 
    { name: 'Dogs Basic Extra large long hair', details: 'Cick for more details', price: '$100', duration: '2 hours', descriptions: descriptions.fullSpaDogs  }, 
    { name: 'Dogs Basic extra large dog standard poodle and poddle mix spa', details: 'Cick for more details', price: '$120', duration: '4 hours', descriptions: descriptions.catLionCut  }, 
    { name: 'Dogs Basic extra small spa double coat', details: 'Cick for more details', price: '$70', duration: '2 hours', descriptions: descriptions.catLionCut  }, 
    { name: 'Cocker Spaniel, Cavalier Charles Kings, Cookapoo Or Similares Mixes', details: 'Cick for more details', price: '$90', duration: '2 hours', descriptions: descriptions.fullSpaDogs  }, 
    { name: 'Boarding Services X 24 Hours', details: 'Cick for more details', price: '$50', duration: '1 hour', descriptions: descriptions.boarding24 }, 
    { name: 'Daycare Day/ dogs stay 9am to 7pm', details: 'Cick for more details', price: '$30', duration: '1 hour', descriptions: descriptions.catLionCut },
    { name: 'Daycare half day/up to 5 hours', details: 'Cick for more details', price: '$15', duration: '30 min', descriptions: descriptions.rabiesCert },
